...
class System_model:
    ...
    def __init__(self, B_total=200): # total band resource is a variable parameter, range from 2 to 20 MHz
    ...
    def calculate_fading(self, stdShadow, dist):
        ...
        h_small = math.pow(ray_array[0],2)+ math.pow(ray_array[1],2)
    ...
    #Calculate the transfer rate: RTm=Bm*log2(1+Sm*hm/(sigma²*Bm))
    def calculate_R(self, m):
        ...
        #print("SNR:")
        #print(self.S[m]*self.calculate_fading(self.stdShadow,self.D[m])/((self.Sigma_square[m] *self.B_total/3.0)))
